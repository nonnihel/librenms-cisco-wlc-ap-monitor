...
final class AccessPointController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $aps = $query
            ->orderByRaw("FIELD(state, 'down', 'up', 'ignored', 'retired')")
        ...
        return view('cisco-wlc-ap-monitor::index', compact('aps', 'devices', 'counts', 'state', 'deviceId', 'search'));
    }
